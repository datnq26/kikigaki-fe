<template>
    ...
    >
        ...
        <div
            ...
            class="group-btn-auth"
            style="background: linear-gradient(180deg, #fee1e1 0%, #fff 42.1%)"
        >
            <el-row justify="space-between">
                <el-col :span="15">
                    <p class="">
                        Vui lòng bấm nút liên hệ <br />
                        để có thể liên hệ trực tiếp với chúng tôi
                    </p>
                    <div>
                        <el-button
                            type="danger"
                ...
                <el-col :xs="9" :sm="5" :md="5" :lg="5" :span="8">
                    <img
                        src="https://fptshop.com.vn/img/login_mobile.png?w=360&q=60"
                        alt="img-mobile"
                    />
                </el-col>
            </el-row>
        ...
        <div style="display: flex; align-items: center" v-else>
            <div
                ...
                "
            >
                <el-avatar src="" class="avatar-image" />
        ...
        <div>
            ...
            >
                <el-menu-item
                    v-if="authenticationStore?.role.toString() === 'admin'"
